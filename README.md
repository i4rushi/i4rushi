...
- [cite_start]**Mentoring Engineers:** As a **Teaching Assistant**, I guide students through advanced Data Structures & Algorithms (C/C++) and Graph Traversal logic[cite: 19, 22].
- **Upskilling:** Deepening my expertise in **MLOps** pipelines and **Edge AI** optimization for resource-constrained hardware.

### 🚀 Recently Shipped
- [cite_start]**Autonomous Line Follower:** Engineered a vision pipeline using **ROS**, **OpenCV (HSV)**, and a **PID controller** to enable precise state estimation and autonomous navigation[cite: 34, 36, 37].
- [cite_start]**Smart Expense Analyzer:** Built a data pipeline leveraging **Tesseract OCR** for text extraction and **Unsupervised Learning (Agglomerative Clustering)** to categorize financial data[cite: 40, 41].
- [cite_start]**Sentiment Analysis Engine:** Designed a custom **Deep Learning architecture** (Embedding + Global Avg Pooling) to classify text with 85% accuracy after processing 20k+ samples[cite: 46, 47].
...
- [cite_start]**Probabilistic Statistics** and **Dynamic Programming** for algorithm optimization[cite: 28].
- Advanced **Transformer architectures** beyond standard BERT/GPT models.
- [cite_start]**n8n** for advanced workflow automation and ETL processes[cite: 9].

### 💬 Ask me about
- [cite_start]**Algorithmic Optimization:** As a TA, I love discussing asymptotic analysis, balanced trees, and graph traversal[cite: 22].
- [cite_start]**AI Implementation:** Chat with me about fine-tuning AI agents, building custom architectures in **TensorFlow/Keras**, or validating mathematical proofs in **LaTeX**[cite: 17].

### ⚡ Fun fact
[cite_start]I spent a summer acting as a human-in-the-loop evaluator for Generative AI, reviewing over **500+ responses weekly** in Calculus, Linear Algebra, and Python to rigorously train models to achieve 70%+ accuracy! [cite: 16]
